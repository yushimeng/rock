...
func ParseLine(startLine string) (msg Message, err error) {
	if isRequest(startLine) {
		...
		msg = NewRequest(method, &recipient, sipVersion)
		return msg, nil
	}
	...
	if isResponse(startLine) {
		...
		msg = NewResponse(sipVersion, statusCode, reason)
		return msg, nil
	}
...
func (p *Parser) ParseHeader(headerText string) (header Header, err error) {
